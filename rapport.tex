...
\begin{itemize}
    ...
    \item \textbf{cellList.c} : contient les fonctions et structures pour manipuler des listes des chaînes des caractères : \verb|Cell|, \verb|List| (liste simplement chaînée), etc.
    \item \textbf{fsop.c} : contient les fonctions pour manipuler des fichiers et dossiers : \verb|listdir|, \verb|blobFile|, etc.
    \item \textbf{workTree.c} : contient les fonctions et structures pour manipuler ensembles de fichiers : \verb|WorkFile|,
    \verb|WorkTree| (arbre des dossiers et des fichiers comme feuilles),
    \verb|saveWorkTree|, \verb|restoreWorkTree|, etc.
    \item \textbf{gestionCommits.c} : contient les fonctions et structures permettant naviguer entre instantanés, construire et maintenir arborescence des différentes versions de projet :
    \verb|Commit| (table de hachage), etc.
    \item\textbf{myGit.c} : le code sur l'interface utilisateur et les interactions : \verb|main|, etc.
